...
public class Main {
	...
	public boolean scale(int opId, int newOpId) throws IOException{
		return mc.parallelizeOpManualOption(opId, newOpId);
	}
	
	public void scale1() {
		mc.parallelizeOpManualOption1();
	}
	
	public void scale2(int opId, int newOpId){
		mc.parallelizeOpManualOption2(opId, newOpId);
	}
