...
public class StatelessProcessingUnit implements IProcessingUnit {
	...
	@Override
	public void sendData(DataTuple dt, ArrayList<Integer> targets) throws ValuedException {
			...
			try{
				...
				// REMOTE SYNC
					...
					try{
						...
						int opIdToDelete = dest.getOperatorId();
						ValuedException e = new ValuedException(opIdToDelete, "An operator has failed. Please remove it. ");
						throw e;
					}
